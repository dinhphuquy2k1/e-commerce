<template>
    <div class="ms-featured_product-container row gap-24">
        <div class="ms-feature-product_main ms-computer-main d-flex flex-column col-lg-10">
            <TabView :scrollable="true" :activeIndex="1">
                <TabPanel v-for="(tab, index) in tabs" :key="tab.title" :header="tab.title" :disabled="index == 0 ? true : false">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 ms-item position-relative" v-for="item in products" :key="item">
        ...
        <div class="ms-feature-product-discount col-lg-2 d-flex flex-column justify-content-between">
...
export default {
    ...
    data() {
        return {
            rating: 5,
            tabs: [
                { title: 'Phụ kiện máy tính', content: 'Tab 0 Content'},
                { title: 'Tất cả', content: 'Tab 0 Content'},
                { title: 'Bàn phím & chuột', content: 'Tab 1 Content'},
                { title: 'Tai nghe', content: 'Tab 2 Content'},
                { title: 'Webcam', content: 'Tab 3 Content'},
                { title: 'Máy in', content: 'Tab 5 Content'},
